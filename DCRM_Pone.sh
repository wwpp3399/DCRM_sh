...
priority=2
directory=/opt/wwwroot/DCRM
command=/usr/bin/python3 manage.py rqworker high

[program:default]
priority=3
directory=/opt/wwwroot/DCRM
command=/usr/bin/python3 manage.py rqworker default" > /etc/supervisord.d/dcrm.ini

echo "# encoding=utf8
import sys

reload(sys)
sys.setdefaultencoding('utf8')" > /usr/lib/python3.6/site-packages/sitecustomize.py
